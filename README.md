...
Основной сценарий начинается с **«Создать заявку на финансирование»** / 主流程从 **“创建供应链融资申请”** 开始，并按“申请—评估—决策—控制—审计”完成一笔业务闭环。Кнопка **«Загрузить 3 готовых кейса»** / **“载入 3 组预置案例”** 保留用于快速对比三类决策。
