...
Run a preregistered, multi-institution study with governed real-enterprise outcomes, stronger temporal baselines, ablations, calibration and subgroup analysis, drift monitoring, and decision-cost evaluation. Keep candidate training reproducible and offline; require independent validation and explicit human approval before promotion.
