...
| Thirty-run statistics, paired tests, and ablations | §4.1–§4.4, body PDF pp.51–66 | Single deterministic reference rerun; multi-seed package not executed | NOT IMPLEMENTED | THESIS_REPORTED | Frozen thesis only | Current ROC-AUC values must not be presented as reproducing the thesis t-tests, significance, or ablation tables |
