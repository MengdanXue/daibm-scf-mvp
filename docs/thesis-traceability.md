...
| Synthetic 500 × 24 reference dataset | §4.1.2 comparison context, body PDF p.51 | Deterministic generator and manifest | IMPLEMENTED | SYNTHETIC_DEMO | Invariant tests; reference SHA-256 `c40534dd8d91454b5986cb9048eb9facf88578221e75c113dab21df08ca3e99c` | Not representative empirical data |
...
| Model version registry | Research traceability requirement | PostgreSQL model/data/graph registries | PARTIAL | 2026_REIMPLEMENTATION | Migration and schema-drift tests | Schema is implemented; runtime registration is pending |
